(function () {
    ...
    try {
        ...
        var experiments = {
            ...
            test_Recipe_215_Hide_VI3D_Keep_VIMR_PDP_All() {
                ...
                if (pathCheck.includes('product.html')) {
                    ...
                    window._conv_q = window._conv_q || [];
                    window._conv_q.push(["executeExperiment", "1004168034"]);
                    console.log("Test Recipe 121 (v2) | See/feel video widget | All Activated");
                    // }, 25, 15000);
                }
            }, test_Recipe_KI255_Show_Hide_Roomvo_Measure_All_CRO6426() {
                var pathCheck = window.location.pathname;
                if (pathCheck.includes('product.html')) {
                    lib.waitForElement('#calc_btn', function () {
                        window.crotest_KI255_Show_Hide_Roomvo_Measure = 1;
                        window._conv_q = window._conv_q || [];
                        window._conv_q.push(["executeExperiment", "1004170438"]);
                        console.log("Test Recipe KI255 | Show/Hide Roomvo Measure (Ai)| All [CRO-6426] Activated");
                    }, 25, 15000);
                }
                ...
                if (pathCheck.includes('product.html')) {
                    lib.waitForElement('#calc_btn', function () {
                        ...
                        window._conv_q = window._conv_q || [];
                        window._conv_q.push(["executeExperiment", "1004173846"]);
                        console.log("Test Recipe KI238.KI239.KI240.KI241 | Emphasizing Tile Calculator Button (v4) - Icon | ALL | CRO-5837 Activated");
                    }, 25, 15000);
                }
            }, test_Recipe_KI238_KI239_KI240_KI241_Emphasizing_Tile_Calculator_Button_v3_Position_color_ALL_CRO5836() {
                var pathCheck = window.location.pathname;
                if (pathCheck.includes('product.html')) {
                    lib.waitForElement('#calc_btn', function () {
                        window.crotest_Emphasizing_Tile_Calculator_Button_v3 = 1;
                        window._conv_q = window._conv_q || [];
                        window._conv_q.push(["executeExperiment", "1004174813"]);
                        console.log("Test Recipe KI238.KI239.KI240.KI241 | Emphasizing Tile Calculator Button (v3) - Position + color | ALL | CRO-5836 Activated");
                    }, 25, 15000);
                }
            }, test_Recipe_KI251_Visualize_in_My_Room_on_PLP_ALL_CRO6311() {
                var pathCheck = window.location.pathname;
                if (pathCheck.indexOf('category.html') != -1 && pathCheck.indexOf('tiles') != -1) {
                    window.crotest_visualize_in_My_Room = 1;
                    window._conv_q = window._conv_q || [];
                    window._conv_q.push(["executeExperiment", "1004174810"]);
                    console.log("Test Recipe KI251 | 'Visualize in My Room' on PLP | ALL | CRO-6311 Activated");
                }
                ...
                if (url.indexOf('/checkout/cart') != -1) {
                    ...
                    window._conv_q = window._conv_q || [];
                    window._conv_q.push(["executeExperiment", "1004171137"]);
                    console.log("Test Recipe KI211 | Buy now pay later from pricing on cart | ALL | CRO-4974 Activated");
                }
            }, test_Recipe_274_275_ATF_Simplification_CTA_Standardisation_All_CRO8111() {
                if (window.location.pathname === "/") {
                    window.crotest_Recipe_274_275_ATF_Simplification_CTA = 1;
                    window._conv_q = window._conv_q || [];
                    window._conv_q.push(["executeExperiment", "1004186871"]);
                    console.log("Test Recipe 274.275 | ATF Simplification & CTA Standardisation | All | CRO-8111 Activated");
                }
            }
        };
        ...
        // experiments.test_Recipe_KI255_Show_Hide_Roomvo_Measure_All_CRO6426();
        // experiments.test_Recipe_KI238_KI239_KI240_KI241_Emphasizing_Tile_Calculator_Button_v4_Icon_ALL_CRO5837();
        // experiments.test_Recipe_KI238_KI239_KI240_KI241_Emphasizing_Tile_Calculator_Button_v3_Position_color_ALL_CRO5836();
        // experiments.test_Recipe_KI251_Visualize_in_My_Room_on_PLP_ALL_CRO6311();
        // experiments.test_Recipe_KI211_Buy_now_pay_later_from_pricing_on_cart_ALL_CRO4974();
        // experiments.test_Recipe_274_275_ATF_Simplification_CTA_Standardisation_All_CRO8111();
        /**
