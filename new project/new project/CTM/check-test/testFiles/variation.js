(function () {
  try {
    ...
    function initializeSwiper() {
      var galleryThumb = new Swiper(".check-test-swiper-thumb-wrapper", {
        slidesPerView: 5,
        spaceBetween: 10,
        freeMode: true,
      ...
      var galleryTop = new Swiper(".check-test-swiper-wrapper", {
        slidesPerView: 1,
        loop: false,
        centeredSlides: false,
        navigation: {
          nextEl: ".check-test-next",
          prevEl: ".check-test-prev",
        },
        speed: 300,
        spaceBetween: 10,
        thumbs: {
    ...
    if (!window.cro_check_test) {
      croEventHandkler();
      window.cro_check_test = true;
    }
