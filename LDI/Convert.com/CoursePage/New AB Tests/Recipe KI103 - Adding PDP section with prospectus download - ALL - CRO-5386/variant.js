                            ...
                            <div class="elementor-button-wrapper">
                                <a class="elementor-button elementor-button-link elementor-size-sm">
                                    <span class="elementor-button-content-wrapper">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M13 17.5L18.5 12L13 6.5M17.25 12H4.25" stroke="white" stroke-width="1.5" stroke-linecap="square"></path></svg>
                                    </span>
                                </a>
                            </div>
                        </div>
            ...
            waitForElement('h2.elementor-heading-title', function () {
                if (window.location.href.includes("orthodontics-dentofacial-orthopaedics")) {
                    document.querySelectorAll('h2.elementor-heading-title').forEach(function (e) {
                        ...
                        // }
                        if (e.textContent.includes('Programme Fee')) {
                            e.closest('.e-parent').classList.add('cro-t-103-programmeFee');
                        }
                        if (e.textContent.includes('UK qualifications accessible worldwide')) {
                            e.closest('.e-parent').classList.add('cro-t-103-accessible');
                        }
                        // if (e.textContent.includes('Why students loved this course')) {
                        //     e.closest('.e-parent').classList.add('cro-t-103-course');
                        // }
        ...
        function addingSection(){
            waitForElement("#CourseOverview", function () {
                if (!document.querySelector(".cro-t-103-courseProspectus")) {
                    insertHtml("#CourseOverview", cro_103_prospectus, "afterend");
                }
            });
