        ...
        init: function (options) {
            ...
            $("#" + sliderName).slider({
                ...
                slide: function (event, ui) {
                   ...
                   // console.log(ui);
                    let rangeValue = ui.values;
                  // update min and max input field of shopify filter
                  
                  let inputMinVal = Number(rangeValue[0]);
                  let inputMaxVal = Number(rangeValue[1]);
                  
                  inputMin.value = inputMinVal;
                  inputMin.setAttribute('max',inputMinVal);
                  //inputMin.dispatchEvent(new Event('change'));
                  inputMin.dispatchEvent(new Event('input', { 'bubbles': true }));
                  
                  inputMax.value = inputMaxVal;
                  inputMax.setAttribute('min',inputMaxVal);
