...
<section class="hero">
  ...
  <div class="wrap hero-in">
    <div class="hero-copy">
      ...
      <h1>Insurance that pays your <span class="hl cro-height">claims</span> upfront.</h1>
      ...
      <div class="hero-router" id="router">
        ...
        <div class="router-grid" role="radiogroup" aria-label="Choose a product to quote">
          <button type="button" class="rchip is-selected" role="radio" aria-checked="true" data-label="Health" data-url="https://health.oneplan.co.za/?referrer=homepagequote">
            ...
            <span class="txt"><span class="rname cro-height">Health</span><span class="rprice cro-height">from R250<small>/mo</small></span></span>
          ...
          <button type="button" class="rchip" role="radio" aria-checked="false" data-label="Pet" data-url="https://www.onepet.co.za?referrer=homepagequote">
            ...
            <span class="txt"><span class="rname cro-height">Pet</span><span class="rprice cro-height">from R80<small>/mo</small></span></span>
            <span class="rtick"><svg><use href="#cro12574-check"></use></svg></span>
          </button>
          <button type="button" class="rchip" role="radio" aria-checked="false" data-label="Gap" data-url="https://gap.oneplan.co.za/?Referrer=homepagequote">
            ...
            <span class="txt"><span class="rname cro-height">Gap</span><span class="rprice cro-height">from R150<small>/mo</small></span></span>
            <span class="rtick"><svg><use href="#cro12574-check"></use></svg></span>
          </button>
          <button type="button" class="rchip" role="radio" aria-checked="false" data-label="Car &amp; Household" data-url="https://oneplanshortterm.co.za/?referrer=homepagequote">
            ...
            <span class="txt"><span class="rname cro-height">Car &amp; Household</span><span class="rprice cro-height">Tailored</span></span>
            <span class="rtick"><svg><use href="#cro12574-check"></use></svg></span>
          </button>
        </div>
        <div class="hero-cta">
          <a class="btn btn-teal" id="quoteCta" href="https://health.oneplan.co.za/?referrer=homepagequote"><span class='cro-height'>Get my Health quote </span><svg><use href="#cro12574-arrow"></use></svg></a>
          <span class="time"><svg><use href="#cro12574-clock"></use></svg><span class="cro-height"> About 2 minutes</span></span>
        </div>
      </div>
...
<div class="wrap trust-wrap">
  <div class="trust-ribbon">
    ...
    <span class="tr-main">
      <span class="tr-num cro-height-rev">4.59</span>
      <div class="stars-text">
<img class="stars" src="https://www.oneplan.co.za/assets/landings/img/hellopeterstars.svg" alt="4.59 stars">
<span class="tr-based mobile">Based on <b>23,019</b> reviews</span></div>
    </span>
    <span class="tr-based">Based on <b>23,019</b> reviews</span>
    <span class="tr-dot"></span>
    <span class="tr-stats">
      <span class="tr-stat cro-height-rev"><b>23,019</b>&nbsp;reviews</span>
      <span class="tr-dot"></span>
      <span class="tr-stat cro-height-rev"><b>10/10</b>&nbsp;Trust Index</span>
    </span>
  </div>
</div>
  ...
  <div class="wrap">
    ...
    <div class="card-grid">
      ...
      <div class="pcard">
        ...
        <div class="pcta">
          <a class="btn btn-teal" href="https://www.onepet.co.za?referrer=homepagequote"><span class="cro-height btn">Get online quote </span><svg><use href="#cro12574-arrow"></use></svg></a>
      ...
      <div class="pcard">
        ...
        <div class="pcta">
          <a class="btn btn-teal" href="https://gap.oneplan.co.za/?Referrer=homepagequote"><span class="cro-height btn">Get online quote </span><svg><use href="#cro12574-arrow"></use></svg></a>
      ...
      <div class="pcard">
        ...
        <div class="pcta">
          <a class="btn btn-teal" href="https://oneplanshortterm.co.za/?referrer=homepagequote"><span class="cro-height btn">Get online quote </span><svg><use href="#cro12574-arrow"></use></svg></a>
...
<section class="reviews">
    ...
    <p class="rev-all"><a href="https://www.hellopeter.com/oneplan-car-and-household" data-cro-placeholder="verify-destination" target="_blank" rel="noopener">See all 23,019 reviews on Hellopeter &rarr;</a></p>
</section>
  ...
  <div class="wrap">
    ...
    <div class="compare">
      <div class="cmp cmp-old">
        ...
        <ol class="cmp-steps">
          <li><span class="s-n">1</span><span class="cro-height">Pay the doctor or vet yourself</span></li>
          <li><span class="s-n">2</span><span class="cro-height">Submit a claim and wait</span></li>
          <li><span class="s-n">3</span><span class="cro-height">Get refunded weeks later - if approved</span></li>
        </ol>
      </div>
      <div class="cmp cmp-new">
        <div class="cmp-head">With your Oneplan Card</div>
        <ol class="cmp-steps">
          <li><span class="s-n"><svg><use href="#cro12574-check"></use></svg></span><span class="cro-height">We load the claim onto your card</span></li>
          <li><span class="s-n"><svg><use href="#cro12574-check"></use></svg></span><span class="cro-height">Tap to pay the bill on the spot</span></li>
          <li><span class="s-n"><svg><use href="#cro12574-check"></use></svg></span><span class="cro-height">Done - never out of pocket</span></li>
        </ol>
      </div>
    </div>
...
<section class="answers" id="answers">
  <div class="wrap">
    ...
    <div class="ans-grid">
      <div class="ans">
        <h4><span class="dot"></span><span class="cro-height col">What does it cover?</span></h4>
      ...
      <div class="ans">
        <h4><span class="dot"></span><span class="cro-height col">How much does it cost?</span></h4>
      ...
      <div class="ans">
        <h4><span class="dot"></span><span class="cro-height col">Is there a waiting period?</span></h4>
  ...
  <div class="wrap">
    ...
    <div class="ss-in">
      <a href="https://www.oneplan.co.za/login" data-cro-placeholder="verify-destination">
        ...
        <span class="ss-tx"><b>Log in</b><span class="ss-sub"><span class="cro-height">Manage your policy </span><svg><use href="#cro12574-arrsm"></use></svg></span></span>
      </a>
      <a href="https://www.oneplan.co.za/claims/claimsprocess">
        <span class="ss-ic"><svg><use href="#cro12574-claim"></use></svg></span>
        <span class="ss-tx"><b>Make a claim</b><span class="ss-sub"><span class="cro-height">Start or track a claim </span><svg><use href="#cro12574-arrsm"></use></svg></span></span>
      </a>
      <a class="wa" href="https://api.whatsapp.com/send?phone=27837945452&text=Hello" data-cro-placeholder="verify-destination">
        ...
        <span class="ss-tx"><b>Chat on WhatsApp</b><span class="ss-sub"><span class="cro-height">Talk to us now </span><svg><use href="#cro12574-arrsm"></use></svg></span></span>
      </a>
    </div>
  </div>
</section>
...
<section class="appdl">
  ...
  <img class="ap-phone" src="https://crp-clients-images.s3.af-south-1.amazonaws.com/Oneplan/Dev+%7C+AB+Homepage+Redesign+%7C+All+%7C+CRO-12574/CRO-12574-8.png" alt="The Oneplan app on a phone" width="424" height="525" loading="lazy">
    ...
    /* in-page anchor buttons ("Get a free online quote" -> #products, "Make a
    ...
    function initHeroRouter() {
      ...
      /* the CTA label may be a bare text node or wrapped in the .cro-height
         line-height-fix span - write wherever the text actually lives */
      function setCtaLabel(text) {
        var span = cta.querySelector('.cro-height');
        if (span) { span.textContent = text; return; }
        if (cta.firstChild && cta.firstChild.nodeType === 3) {
          cta.firstChild.nodeValue = text;
          return;
        }
        cta.insertBefore(document.createTextNode(text), cta.firstChild);
      }
      function select(chip) {
        ...
        setCtaLabel('Get my ' + chip.getAttribute('data-label') + ' quote ');
      }
