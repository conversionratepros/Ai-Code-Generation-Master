(function () {
    try {
        ...
        var experiments = {
            test_83_DBCS_94_Template_Start_new_All() {
            ...
            }, test_Recipe_KI93_Wording_change_Confirm_CTA_it3_Ai_ALL_CRO6614() {
                var pageUrl = window.location.href;
                const isFromClearScore = () => {
                    const params = new URLSearchParams(location.search);
                ...
                if (pageUrl.indexOf('https://start.debtbusters.co.za/custom-landing-pages-debt-counselling-clear-score-landing') != -1) {
                    ...
                    if (isFromClearScore()) {
                        // Your test logic here...
                        window.crotest_test_93_Hide_prefilled_form = 1;
                        window._conv_q = window._conv_q || [];
                        window._conv_q.push(["executeExperiment", "1004175777"]);
                        console.log("TEST Recipe KI93 | Wording change & Confirm CTA (it3) (Ai) | ALL | CRO-6614 Activated");
                    }
                }
            }, test_Recipe_KI92_NonEditable_Fields_it2_ALL_CRO6612() {
                var pageUrl = window.location.href;
                const isFromClearScore = () => {
                    const params = new URLSearchParams(location.search);
                ...
                if (pageUrl.indexOf('https://start.debtbusters.co.za/custom-landing-pages-debt-counselling-clear-score-landing') != -1) {
                    ...
                    if (isFromClearScore()) {
                        // Your test logic here...
                        window.crotest_test_KI92_NonEditable_Fields_it2_ALL_CRO6612 = 1;
                        window._conv_q = window._conv_q || [];
                        window._conv_q.push(["executeExperiment", "1004178360"]);
                        console.log("TEST Recipe KI92 | Non-Editable Fields (it 2) | ALL | CRO-6612 Activated");
                    }
                }
            }
        };
        ...
        experiments.test_Recipe_KI93_Wording_change_Confirm_CTA_it3_Ai_ALL_CRO6614();
        experiments.test_Recipe_KI92_NonEditable_Fields_it2_ALL_CRO6612();
