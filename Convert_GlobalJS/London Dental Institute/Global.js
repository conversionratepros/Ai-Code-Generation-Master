(function () {
	try {
		...
		var experiments = {
			...
			}, test_Recipe_KI112_Register_your_interest_CTA_ALL_CRO_6073() {
				var pathName = window.location.pathname;
				if (pathName == '/' || pathName.includes('/dental-courses') || pathName.includes('/orthodontics-dentofacial-orthopaedics') || pathName.includes('/aesthetic-restorative-dentistry') || pathName.includes('/dental-implantology-oral-surgery')) {
					window.crotest_Register_your_interest_CTA = 1;
					window._conv_q = window._conv_q || [];
					window._conv_q.push(["executeExperiment", "1004174300"]);
					console.log("Experiment Recipe KI112 | 'Register your interest' CTA | ALL | CRO-6073 Activated");
				}
			},
			test_Recipe_KI122_KI121_Mentor_Highlight_and_Improved_Imagery_on_Homepage_ALL_CRO6683() {
				var pathName = window.location.pathname;
				if (pathName == '/') {
					window.crotest_Improved_Imagery_on_Homepage = 1;
					window._conv_q = window._conv_q || [];
					window._conv_q.push(["executeExperiment", "1004174814"]);
					console.log("Experiment Recipe KI122.KI121 | Mentor Highlight and Improved Imagery on Homepage | ALL | CRO-6683 Activated");
				}
			}, test_Recipe_KI108_Change_Enrol_now_to_Apply_now_ALL_CRO7818() {
				var pathName = window.location.pathname;
				if (pathName.includes('/orthodontics-dentofacial-orthopaedics') || pathName.includes('/aesthetic-restorative-dentistry') || pathName.includes('/dental-implantology-oral-surgery')) {
					window.crotest_Recipe_KI108_Change_CTA = 1;
					window._conv_q = window._conv_q || [];
					window._conv_q.push(["executeExperiment", "1004175845"]);
					console.log("Experiment Recipe KI108 | Change “Enrol now” to “Apply now” | ALL | CRO-7818 Activated");
				}
			}, test_Recipe_KI130_Add_urgency_by_emphasizing_instant_access_ALL_CRO6922() {
				var pathName = window.location.pathname;
				if (pathName == '/' || pathName.includes('/orthodontics-dentofacial-orthopaedics') || pathName.includes('/aesthetic-restorative-dentistry') || pathName.includes('/dental-implantology-oral-surgery')) {
					window.crotest_KI130_Add_urgency_by_emphasizing_instant_access_ALL_CRO6922 = 1;
					window._conv_q = window._conv_q || [];
					window._conv_q.push(["executeExperiment", "1004182178"]);
					console.log("Experiment Recipe KI130 | Add urgency by emphasizing instant access | ALL | CRO-6922 Activated");
				}
			}, test_Recipe_KI138_ATF_Course_Page_Redesign_ALL_CRO8171() {
				var pathName = window.location.href;
				if (pathName.includes('/orthodontics-dentofacial-orthopaedics') || pathName.includes('/aesthetic-restorative-dentistry') || pathName.includes('/dental-implantology-oral-surgery')) {
					window.crotest_KI138_ATF_Course_Page_Redesign_ALL_CRO8171 = 1;
					window._conv_q = window._conv_q || [];
					window._conv_q.push(["executeExperiment", "1004182635"]);
					console.log("Experiment Recipe KI138 | ATF Course Page Redesign | ALL | CRO-8171 Activated");
				}
			}
		...
		experiments.test_Recipe_KI112_Register_your_interest_CTA_ALL_CRO_6073();
		experiments.test_Recipe_KI122_KI121_Mentor_Highlight_and_Improved_Imagery_on_Homepage_ALL_CRO6683();
		experiments.test_Recipe_KI108_Change_Enrol_now_to_Apply_now_ALL_CRO7818();
		experiments.test_Recipe_KI130_Add_urgency_by_emphasizing_instant_access_ALL_CRO6922();
		experiments.test_Recipe_KI138_ATF_Course_Page_Redesign_ALL_CRO8171();
		/**
