(function () {
    try {
        ...
        var experiments = {
            ...
            test_AB_Test_Sticky_search_bar_listing_pages_CRO12371() {
                var currentPath = window.location.pathname;
                if (currentPath.indexOf('/brands') == -1 || currentPath.indexOf('/sales') == -1) {
                    lib.waitForElement('#multiForm', function () {
                        window.crotest_AB_Test_Sticky_search_bar_listing_pages_CRO12371 = 1;
                        window._conv_q = window._conv_q || [];
                        window._conv_q.push(["executeExperiment", "1004202567"]);
                        console.log("Experiment AB Test | Sticky search bar (listing pages) | CRO-12371 Activated");
                    }, 50, 20000)
                ...
                setTimeout(function(){
                    if (currentPath.indexOf('/brands') != -1){
                        if(document.querySelector(".cro-12371")){
                            document.querySelector("body").classList.remove('cro-12371')
                        }
                    }
                },600)
        ...
        experiments.test_AB_Test_Sticky_search_bar_listing_pages_CRO12371();
    } catch (e) {
