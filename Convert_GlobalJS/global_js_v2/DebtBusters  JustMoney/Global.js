(function () {
    "use strict";
    /* ================================================================
       CRO Global Project JS — DebtBusters JustMoney (v2, status-gated scaffold)
    ...
    try {
        ...
        if (!window.cro_justMoney_globalJS) { // rename per client
            window.cro_justMoney_globalJS = true;
