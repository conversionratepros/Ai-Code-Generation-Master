(function () {
    "use strict";
    /* ================================================================
       CRO Global Project JS — Oneplan (v2, status-gated)
    ...
    try {
        ...
        var tests = [
            {
                ticket: "CRO-12574",
                name: "Dev | AB Homepage Redesign | All",
                id: "1004206057",
                flag: "crotest_AB_Homepage_Redesign_All_CRO12574",
                classes: [],
        ...
        /* ================================================================
           ...
           Oneplan v1 has none; add here when needed.
           ================================================================ */

        function runDecorators() {
            /* none for Oneplan (v1 had no decorators) */
        }
        ...
        if (!window.cro_oneplan_globalJS) {
            window.cro_oneplan_globalJS = true;
