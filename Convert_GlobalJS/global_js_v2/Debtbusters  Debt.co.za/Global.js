(function () {
    "use strict";
    /* ================================================================
       CRO Global Project JS — Debtbusters Debt.co.za (v2, status-gated scaffold)
    ...
    try {
        ...
        if (!window.cro_debtCoZa_globalJS) { // rename per client
            window.cro_debtCoZa_globalJS = true;
