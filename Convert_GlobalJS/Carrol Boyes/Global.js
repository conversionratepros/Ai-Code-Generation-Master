	...
	try {
		...
		var experiments = {
			...
			test_Recipe_Fable_USP_Section_All_CRO412() {
				...
				var pageUrl = window.location.href;
				if (pageUrl.includes("/deals.html")) {
					lib.waitForElement('a.view-za', function () {
			...
			}, test_Recipe_86_Pay_sidebar_Desktop_CRO_1561() {
				var pageUrl = window.location.href;
				if (pageUrl.includes("/za/checkout")) {
					window.crotest_86_Pay_sidebar_Desktop_CRO_1561 = 1;
					window._conv_q = window._conv_q || [];
					window._conv_q.push(["executeExperiment", "1004171027"]);
					console.log("Experiment Recipe 86 | Pay sidebar | Desktop | CRO-1561 Activated");
				}
			},
			test_KI153_Simplifying_Side_Bar_Menu_Categorisation_ALL_CRO_5296() {
				var pageUrl = window.location.href;
				if (pageUrl.includes(".html")) {
					lib.waitForElement('.switcher.language.switcher-language:not(#switcher-language-nav) a.view-za', function () {
						lib.waitForElement('.catalog-category-view', function () {
							window.crotest_KI153_Simplifying_Side_Bar_Menu_Categorisation_ALL_CRO_5296 = 1;
							window._conv_q = window._conv_q || [];
							window._conv_q.push(["executeExperiment", "1004171147"]);
							console.log("Experiment KI153 | 🤖 Simplifying Side Bar Menu Categorisation (Ai) | ALL | CRO-5296 Activated");
						}, 50, 15000)
			...
			}, test_Recipe_127_Delivery_timelines_PDP_Nav_All_CB408() {
				lib.waitForElement('body.catalog-product-view', function () {
					window.crotest_127_Delivery_timelines_PDP_Nav_All_CB408 = 1;
					window._conv_q = window._conv_q || [];
					window._conv_q.push(["executeExperiment", "1004110230"]);
					console.log("Experiment Recipe 127 | Delivery timelines PDP & Nav | All | CB-408 Activated");
				}, 50, 15000)
			},
			test_Recipe_KI134_KI92_KI93_KI94_KI130_KI91_KI95_KI98_Full_width_cart_drawer_Mobile_CRO5163() {
				lib.waitForElement('a.view-za', function () {
					window.crotest_Full_width_cart_drawer_Mobile = 1;
					window._conv_q = window._conv_q || [];
					window._conv_q.push(["executeExperiment", "1004168181"]);
					console.log("Experiment Recipe KI134.KI92.KI93.KI94.KI130.KI91.KI95.KI98 | Full width cart drawer | Mobile | CRO-5163 Activated");
			...
			}, test_Recipe_KI154_Black_CTA_Buttons_ALL_CRO6452() {
				var pageUrl = window.location.href;
				if (!pageUrl.includes("gift-voucher-1.html") && !pageUrl.includes("/za/deals.html")) {
					lib.waitForElement('a.view-za', function () {
						window.crotest_KI154_Black_CTA_Buttons_ALL_CRO6452 = 1;

						function croTest() {
							window._conv_q = window._conv_q || [];
							window._conv_q.push(["executeExperiment", "1004179210"]);
							console.log("Experiment Recipe KI154 | Black CTA Buttons | ALL | CRO-6452 Activated");
						}
						...
						lib.waitForElement('body.cms-home', function () {
							croTest();
						}, 50, 15000)
					}, 50, 15000)
				}
			}, test_147_3_column_PDP_Desktop_CRO688() {
				lib.waitForElement('body.catalog-product-view', function () {
					window.crotest_147_3_column_PDP_Desktop_CRO_688 = 1;
					window._conv_q = window._conv_q || [];
					window._conv_q.push(["executeExperiment", "1004133461"]);
					console.log("Experiment Recipe 147 | 3 column PDP | Desktop | CRO-688 Activated");
				}, 50, 15000)
			}
		};
		...
		experiments.test_Recipe_86_Pay_sidebar_Desktop_CRO_1561();
		experiments.test_KI153_Simplifying_Side_Bar_Menu_Categorisation_ALL_CRO_5296();
		experiments.test_Recipe_127_Delivery_timelines_PDP_Nav_All_CB408();
		experiments.test_Recipe_KI134_KI92_KI93_KI94_KI130_KI91_KI95_KI98_Full_width_cart_drawer_Mobile_CRO5163();
		experiments.test_Recipe_KI154_Black_CTA_Buttons_ALL_CRO6452();
		experiments.test_147_3_column_PDP_Desktop_CRO688();
		/**
